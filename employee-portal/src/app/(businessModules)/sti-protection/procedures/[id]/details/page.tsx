...
import { EditPersonalDataSidebar } from "@/lib/businessModules/stiProtection/features/procedures/details/EditPersonalDataSidebar";
...
export default function StiProtectionProcedureDetailsPage({
  ...
  return (
    <>
      <ProcedureDetails procedureId={params.id} />
      <EditPersonalDataSidebar procedureId={params.id} />
    </>
  );
}
