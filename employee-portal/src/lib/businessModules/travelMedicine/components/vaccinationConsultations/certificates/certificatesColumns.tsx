...
function decorateCertificateType(
  ...
  const title = formatCertificateType(certificateType);
...
function formatCertificateType(
  ...
  return certificateType ? "Vorlage bei der Krankenkasse" : "-";
}
...
export function vaccinationConsultationCertificatesColumns(
