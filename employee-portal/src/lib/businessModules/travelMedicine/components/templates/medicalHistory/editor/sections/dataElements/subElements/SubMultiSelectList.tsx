...
import { ApiMedicalHistoryTemplateSubElementMultiSelect } from "@eshg/employee-portal-api/travelMedicine/models";
import { Stack } from "@mui/joy";

import { SubMultiSelectElement } from "@/lib/businessModules/travelMedicine/components/templates/medicalHistory/editor/sections/dataElements/subElements/SubMultiSelectElement";
...
export function SubMultiSelectList({
  ...
  multiSelectElements: ApiMedicalHistoryTemplateSubElementMultiSelect[];
