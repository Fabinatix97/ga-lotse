...
import {
  ...
  ApiMedicalHistoryTemplateSectionElement,
...
import { SectionTitle } from "@/lib/businessModules/travelMedicine/components/templates/medicalHistory/editor/sections/SectionTitle";
import { TemplateSection } from "@/lib/businessModules/travelMedicine/components/templates/medicalHistory/editor/sections/TemplateSection";

export function createEmptySection() {
  const section: ApiMedicalHistoryTemplateSection = {
    sectionTitle: "",
...
export function createEmptySectionElement() {
  const sectionElement: ApiMedicalHistoryTemplateSectionElement = {
