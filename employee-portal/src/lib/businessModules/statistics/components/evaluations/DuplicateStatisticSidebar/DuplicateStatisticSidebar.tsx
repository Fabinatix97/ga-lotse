...
import { DuplicateStatisticFormModel } from "@/lib/businessModules/statistics/components/evaluations/DuplicateStatisticSidebar/duplicateStatisticFormModel";
...
export function DuplicateStatisticSidebar(props: {
  ...
  async function handleSubmit(model: DuplicateStatisticFormModel) {
    ...
    await duplicateStatistic({
      originalEvaluationId: props.originalStatistic.id,
      clonedEvaluationName: newStatisticName,
    });
  }
