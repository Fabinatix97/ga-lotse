...
For a fast setup, you can use the pre-configured Gradle tasks as specified link:docs/gradle.adoc#_root_project_tasks[here] in chapter "Root project tasks".
...
If you wish to conserve resources, you can start the services individually. See the instructions available link:docs/frontend.adoc#_getting_started[here] in chapter "Getting started" details on starting each microservice separately.
...
* port mappings for all services see link:backend/README.md[here].

Login information for the test users can be found link:backend/README.md[here].
