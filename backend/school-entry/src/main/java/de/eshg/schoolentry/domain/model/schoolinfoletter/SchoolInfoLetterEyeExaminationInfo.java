...
public class SchoolInfoLetterEyeExaminationInfo extends BaseEntity {
  ...
  private boolean spectacleWearer;
  private boolean underTreatment;
  private boolean colorSenseDisorder;
  ...
  public boolean isSpectacleWearer() {
    return spectacleWearer;
  }

  public void setSpectacleWearer(boolean spectacleWearer) {
    this.spectacleWearer = spectacleWearer;
  }
  ...
  public boolean isColorSenseDisorder() {
    return colorSenseDisorder;
  }

  public void setColorSenseDisorder(boolean colorSenseDisorder) {
    this.colorSenseDisorder = colorSenseDisorder;
  }
}
