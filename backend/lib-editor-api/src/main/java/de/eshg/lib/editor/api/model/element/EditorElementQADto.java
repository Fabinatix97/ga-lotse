...
@Schema(name = "EditorElementQA")
public class EditorElementQADto extends EditorElementDto {

  @NotNull private final String title;
  @NotNull @Valid private final List<EditorElementAnswerDto> answers;

  @JsonCreator
  public EditorElementQADto(
      ...
      @NotNull @Valid @JsonProperty("answers") List<EditorElementAnswerDto> answers) {
  ...
  public EditorElementType getType() {
    return EditorElementType.QUESTION_AND_ANSWERS;
  }
  ...
  public List<EditorElementAnswerDto> getAnswers() {
    return answers;
  }
}
