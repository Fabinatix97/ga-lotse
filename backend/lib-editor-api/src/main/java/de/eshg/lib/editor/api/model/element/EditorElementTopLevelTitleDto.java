...
@Schema(name = "EditorElementTopLevelTitle")
public class EditorElementTopLevelTitleDto extends EditorElementDto {

  @NotNull private final String title;

  @JsonCreator
  public EditorElementTopLevelTitleDto(
  ...
  public EditorElementType getType() {
    return EditorElementType.TOPLEVEL_TITLE;
  }
