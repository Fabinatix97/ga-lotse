...
@Schema(name = "EditorElementAudios")
public class EditorElementAudiosDto extends EditorElementDto {

  @NotNull private final String title;
  @NotNull @Valid private final List<EditorElementAudioDto> audios;

  @JsonCreator
  public EditorElementAudiosDto(
      ...
      @NotNull @Valid @JsonProperty("audios") List<EditorElementAudioDto> audios) {
  ...
  public EditorElementType getType() {
    return EditorElementType.AUDIOS;
  }
  ...
  public List<EditorElementAudioDto> getAudios() {
    return audios;
  }
}
