...
@Schema(name = "EditorElementTextBlock")
public class EditorElementTextBlockDto extends EditorElementDto {

  @NotNull private final String title;
  @NotNull private final String text;

  @JsonCreator
  public EditorElementTextBlockDto(
  ...
  public EditorElementType getType() {
    return EditorElementType.TEXT_BLOCK;
  }
