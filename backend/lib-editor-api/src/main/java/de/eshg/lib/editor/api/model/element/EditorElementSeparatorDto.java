...
@Schema(name = "EditorElementSeparator")
public class EditorElementSeparatorDto extends EditorElementDto {

  @JsonCreator
  public EditorElementSeparatorDto(
  ...
  public EditorElementType getType() {
    return EditorElementType.SEPARATOR;
  }
}
