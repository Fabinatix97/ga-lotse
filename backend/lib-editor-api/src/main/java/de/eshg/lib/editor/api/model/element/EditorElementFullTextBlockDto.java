...
@Schema(name = "EditorElementFullTextBlock")
public class EditorElementFullTextBlockDto extends EditorElementDto {

  @NotNull private final String title;
  @NotNull private final String text;

  @JsonCreator
  public EditorElementFullTextBlockDto(
  ...
  public EditorElementType getType() {
    return EditorElementType.FULL_TEXT_BLOCK;
  }
