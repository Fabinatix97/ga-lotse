...
class FileContentSerializer extends StdSerializer<HasFileContent> {
   ...
   */
  @Override
  public void serialize(HasFileContent fileContent, JsonGenerator gen, SerializerProvider provider)
      throws IOException {
    String collisionFreeFileName = collisionFreeFileNameCreation.apply(fileContent.getFileName());
