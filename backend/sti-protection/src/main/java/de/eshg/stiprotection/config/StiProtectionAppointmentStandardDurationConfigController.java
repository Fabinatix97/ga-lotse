...
import static de.eshg.stiprotection.config.StiProtectionAppointmentStandardDurationConfigController.BASE_URL;
...
@Tag(name = "StiProtectionAppointmentStandardDurationConfig")
public class StiProtectionAppointmentStandardDurationConfigController {
  ...
  public StiProtectionAppointmentStandardDurationConfigController(
  ...
  @GetMapping(SEX_WORK)
  public GetSexWorkAppointmentStandardDurationsResponse
      getSexWorkAppointmentStandardDurationsConfig() {
  ...
  public GetHivStiConsultationAppointmentStandardDurationsResponse
      getHivStiConsultationAppointmentStandardDurationsConfig() {
