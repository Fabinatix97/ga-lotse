<#-- TODO: Delete file once https://github.com/keycloak/keycloak/issues/45227 is closed -->
    ...
    <ul class="${properties.kcSelectAuthListClass!}" role="list">
      <#list auth.authenticationSelections as authenticationSelection>
        <li class="${properties.kcSelectAuthListItemWrapperClass!}">
          ...
          <div role="button" tabindex="0" class="${properties.kcSelectAuthListItemClass!}" onclick="document.forms[${authenticationSelection?index}].requestSubmit()">
