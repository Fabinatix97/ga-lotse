...
public record GetUsersRequest(
    @ArraySchema(
        ...
        @NotNull
        Collection<@NotNull UUID> userIds,
    @Schema(
            description =
                "A flag to ignore Ids of unknown Users in the response. Can be set to suppress errors if they are not important")
        Boolean ignoreUnknownId) {}
