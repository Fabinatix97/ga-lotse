...
import static de.eshg.auditlog.AuditLogApi.QueryParameter.PAGE_NUMBER;
import static de.eshg.auditlog.AuditLogApi.QueryParameter.PAGE_SIZE;
...
public record GetAvailableAuditLogsPaginationOptions(
    @CanBeLogged
  ...
  public GetAvailableAuditLogsPaginationOptions(Integer pageSize, Integer pageNumber) {
