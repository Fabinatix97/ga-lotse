 ...
 */
public class Gdt35PersonBuilder extends BaseBuilder<Gdt35PersonBuilder> {

  @Override
  protected Gdt35PersonBuilder self() {
    return this;
  }
   ...
   */
  public Gdt35PersonBuilder lastName(String value) {
   ...
   * @return This builder instance.
   */
  public Gdt35PersonBuilder firstName(String value) {
   ...
   * @return This builder instance.
   */
  public Gdt35PersonBuilder birthDate(String value) {
   ...
   * @return This builder instance.
   */
  public Gdt35PersonBuilder title(String value) {
   ...
   * @return This builder instance.
   */
  public Gdt35PersonBuilder insuranceNumber(String value) {
   ...
   * @return This builder instance.
   */
  public Gdt35PersonBuilder gender(String value) {
