 ...
 */
public record Gdt35Object(
    String attributeTag, String attributeName, String objectId, List<Gdt35Element> elements)
    implements Gdt35Element {
  ...
  public static Predicate<Gdt35Element> isInstance() {
    return Gdt35Object.class::isInstance;
  }

  public static Function<Gdt35Element, Gdt35Object> cast() {
    return Gdt35Object.class::cast;
  }
