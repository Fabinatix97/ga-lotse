 ...
 */
public sealed interface Gdt35Element permits Gdt35Field, Gdt35Object {
   ...
   *
   * <ul>
   *   <li><b>GdtField</b>: Returns {@link Gdt35Field#tag()} - the 4-digit field identifier (e.g.,
   *       "3101" for lastName, "8310" for requestId). Never null.
   *   <li><b>GdtObject</b>: Returns {@link Gdt35Object#attributeTag()} - the 81xx range tag
