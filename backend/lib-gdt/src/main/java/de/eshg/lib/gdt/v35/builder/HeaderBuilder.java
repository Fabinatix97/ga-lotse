 ...
 */
public class HeaderBuilder extends BaseBuilder<HeaderBuilder> {

  @Override
  protected HeaderBuilder self() {
    return this;
  }
   ...
   */
  public HeaderBuilder software(String value) {
   ...
   * @return This builder instance.
   */
  public HeaderBuilder version(String value) {
   ...
   * @return This builder instance.
   */
  public HeaderBuilder sender(String value) {
   ...
   * @return This builder instance.
   */
  public HeaderBuilder receiver(String value) {
   ...
   *
   * @param config A consumer to configure the {@link TimestampBuilder}.
   * @return This builder instance.
   */
  public HeaderBuilder creationDate(Consumer<TimestampBuilder> config) {
    return addObject(
        "8218", "Timestamp_Erstellung_Datensatz", "Obj_0054", new TimestampBuilder(), config);
  }
}
