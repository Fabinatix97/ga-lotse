 ...
 * times, etc.
 */
public class Gdt35TimestampBuilder extends BaseBuilder<Gdt35TimestampBuilder> {

  @Override
  protected Gdt35TimestampBuilder self() {
    return this;
  }
   ...
   */
  public Gdt35TimestampBuilder date(String value) { // Format YYYYMMDD
   ...
   * @return This builder instance.
   */
  public Gdt35TimestampBuilder time(String value) { // Format HHMMSS
