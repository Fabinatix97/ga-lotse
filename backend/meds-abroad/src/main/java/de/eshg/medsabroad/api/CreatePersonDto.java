...
@Schema(name = "CreatePerson", description = "A person who is applying for approval.")
public record CreatePersonDto(
  ...
  public CreatePersonDto(String firstName, String lastName, LocalDate dateOfBirth) {
    this(
        null,
        null,
        null,
