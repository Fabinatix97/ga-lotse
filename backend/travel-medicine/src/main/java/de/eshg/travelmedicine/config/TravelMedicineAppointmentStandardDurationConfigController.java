...
import static de.eshg.travelmedicine.config.TravelMedicineAppointmentStandardDurationConfigController.BASE_URL;
...
@Tag(name = "TravelMedicineAppointmentStandardDurationConfig")
public class TravelMedicineAppointmentStandardDurationConfigController {
  ...
  public TravelMedicineAppointmentStandardDurationConfigController(
  ...
  public GetTravelMedicineAppointmentStandardDurationsResponse getStandardDurationsConfig() {
