...
import de.eshg.travelmedicine.medicalhistorytemplate.api.MedicalHistoryTemplateContentDto;
import de.eshg.travelmedicine.medicalhistorytemplate.api.MedicalHistoryTemplateDto;
import de.eshg.travelmedicine.medicalhistorytemplate.api.MedicalHistoryTemplateStateDto;
...
import de.eshg.travelmedicine.medicalhistorytemplate.persistence.entity.MedicalHistoryTemplateState;
...
public class MedicalHistoryTemplateMapper {
  ...
  public static MedicalHistoryTemplateDto toInterfaceType(
    ...
    MedicalHistoryTemplateContentDto medicalHistoryTemplateContent;
    try {
      medicalHistoryTemplateContent =
          OBJECT_MAPPER.readValue(
              medicalHistoryTemplate.getContent(), MedicalHistoryTemplateContentDto.class);
