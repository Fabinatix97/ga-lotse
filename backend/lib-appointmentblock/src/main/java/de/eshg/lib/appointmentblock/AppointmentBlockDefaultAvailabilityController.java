...
public class AppointmentBlockDefaultAvailabilityController {
  ...
  static final String BASE_URL = BaseUrls.LibAppointmentBlock.APPOINTMENT_BLOCK_AVAILABILITY_API;
  ...
  public AppointmentBlockDefaultAvailabilityFlagsDto getDefaultFlags() {
    return appointmentBlockAvailabilityService.getDefaultFlags();
  }
}
