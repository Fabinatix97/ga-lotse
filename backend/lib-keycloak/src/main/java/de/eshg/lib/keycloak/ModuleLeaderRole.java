...
public enum ModuleLeaderRole {
  ...
  PROSTITUTE_PROTECTION_LEADER(EmployeePermissionRole.PROSTITUTE_PROTECTION_LEADER),
  INFECTION_BRIEFING_LEADER(EmployeePermissionRole.INFECTION_BRIEFING_LEADER);
