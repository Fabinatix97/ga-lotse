...
public final class BasePublicSecurityConfig extends AbstractPublicSecurityConfiguration {
  ...
  private void streets() {
    ...
    requestMatchers(GET, BaseUrls.Base.STREET_API + BaseUrls.Base.POSTAL_CODE_AND_CITY_URL)
        .hasRole(EmployeePermissionRole.STANDARD_EMPLOYEE);
    requestMatchers(GET, BaseUrls.Base.PUBLIC_STREET_API + BaseUrls.Base.STREET_AUTOCOMPLETE_URL)
        .permitAll();
    requestMatchers(GET, BaseUrls.Base.PUBLIC_STREET_API + BaseUrls.Base.POSTAL_CODE_AND_CITY_URL)
        .permitAll();
  }
