...
Siebenunddreißigster Release der Anwendung GA-Lotse

### Einschulungsuntersuchungen:

* Anpassung des Konfigurators für die Dokumente Arzt- und Schulinfobrief zur Aufnahme von Ansprechpersonen.
...
Sechsundzwanzigster Release der Anwendung GA-Lotse

### Einschulungsuntersuchungen:

* Aktion „Einladung versandt“ auswählbar bei markierten Vorgängen nach dem Herunterladen der Einladungen
* Anzeigeoptionen in der ESU erweitert, sodass nun auch 100 und 200 Einträge auswählbar sind
...
Zwanzigster Release der Anwendung GA-Lotse

### Einschulungsuntersuchungen:

* Planung
  * Anlegen eines Spontantermins zum Starten einer Untersuchung

### Grundfunktionen:

* Optimierungen der Terminblockansicht

## GA-Lotse 2.6
_17.09.2025_

Neunzehnter Release der Anwendung GA-Lotse

### Einschulungsuntersuchungen:

* Planung
  * Adressierung von Einladung an Personensorgeberechtigte möglich
  * Anpassung Anzahl paralleler Slots bei Terminblöcken
  * Anpassung Team bei Terminblöcken
  * Ausschluss von Kennungen bei Vorgangssuche möglich
  * Konfiguration von Vorlaufzeiten für Terminbuchungen
...
* Planung
  ...
  * Vorbelegung bei Planung der Terminblöcke zur Einbeziehung bei Online-Portalbuchungen sowie Massenterminvergabe konfigurierbar
...
Sechzehnter Release der Anwendung GA-Lotse

### Einschulungsuntersuchungen:

* Planung
  * Sortierung und Paginierung der Vorgangstabelle bleibt nach Seitenwechsel erhalten
  * Massenzuweisungen von Kennungen über Vorgangsübersicht möglich
