...
public class UserMapper {
  ...
  public static KeycloakRole mapRoleToDm(UserRoleDto role) {
    return switch (role) {
      ...
      case OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_CREATE ->
          EmployeePermissionRole.OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_CREATE;
      case OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_EDITOR_EDIT ->
          EmployeePermissionRole.OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_EDITOR_EDIT;
      case OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_PREVIEW_READER_EDIT ->
          EmployeePermissionRole.OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_PREVIEW_READER_EDIT;
      case OFFICIAL_MEDICAL_SERVICE_TEXT_TEMPLATES_WRITE ->
          EmployeePermissionRole.OFFICIAL_MEDICAL_SERVICE_TEXT_TEMPLATES_WRITE;
      case OFFICIAL_MEDICAL_SERVICE_LEGAL_NOTES_WRITE ->
      ...
      case PROSTITUTE_PROTECTION_LEADER -> EmployeePermissionRole.PROSTITUTE_PROTECTION_LEADER;
      case PROSTITUTE_PROTECTION_ADMIN -> EmployeePermissionRole.PROSTITUTE_PROTECTION_ADMIN;
      case INFECTION_BRIEFING_LEADER -> EmployeePermissionRole.INFECTION_BRIEFING_LEADER;
      case INFECTION_BRIEFING_ADMIN -> EmployeePermissionRole.INFECTION_BRIEFING_ADMIN;
      case BASE_INTER_MODULE_MIGRATION -> EmployeePermissionRole.BASE_INTER_MODULE_MIGRATION;
      case FILEJOCKEY_MEDICAL_DEVICE -> EmployeePermissionRole.FILEJOCKEY_MEDICAL_DEVICE;
    };
  }
  ...
  private static UserRoleDto mapPermissionRoleToApi(EmployeePermissionRole role) {
    return switch (role) {
      ...
      case PROSTITUTE_PROTECTION_ADMIN -> UserRoleDto.PROSTITUTE_PROTECTION_ADMIN;
      case PROSTITUTE_PROTECTION_LEADER -> UserRoleDto.PROSTITUTE_PROTECTION_LEADER;
      case INFECTION_BRIEFING_ADMIN -> UserRoleDto.INFECTION_BRIEFING_ADMIN;
      case INFECTION_BRIEFING_LEADER -> UserRoleDto.INFECTION_BRIEFING_LEADER;
      ...
      case OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_CREATE ->
          UserRoleDto.OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_CREATE;
      case OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_EDITOR_EDIT ->
          UserRoleDto.OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_EDITOR_EDIT;
      case OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_PREVIEW_READER_EDIT ->
          UserRoleDto.OFFICIAL_MEDICAL_SERVICE_ASSESSMENT_PREVIEW_READER_EDIT;
      case OFFICIAL_MEDICAL_SERVICE_TEXT_TEMPLATES_WRITE ->
          UserRoleDto.OFFICIAL_MEDICAL_SERVICE_TEXT_TEMPLATES_WRITE;
      case OFFICIAL_MEDICAL_SERVICE_LEGAL_NOTES_WRITE ->
          UserRoleDto.OFFICIAL_MEDICAL_SERVICE_LEGAL_NOTES_WRITE;
      case SCHOOL_ENTRY_VACCINATION_CHECK -> UserRoleDto.SCHOOL_ENTRY_VACCINATION_CHECK;
      case BASE_INTER_MODULE_MIGRATION -> UserRoleDto.BASE_INTER_MODULE_MIGRATION;
      case FILEJOCKEY_MEDICAL_DEVICE -> UserRoleDto.FILEJOCKEY_MEDICAL_DEVICE;
    };
  }
