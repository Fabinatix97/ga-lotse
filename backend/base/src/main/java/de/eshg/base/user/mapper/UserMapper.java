...
public class UserMapper {
  ...
  public static KeycloakRole mapRoleToDm(UserRoleDto role) {
    return switch (role) {
      ...
      case BASE_BUNDID_PERSON_LINK_WRITE -> EmployeePermissionRole.BASE_BUNDID_PERSON_LINK_WRITE;
  ...
  private static UserRoleDto mapPermissionRoleToApi(EmployeePermissionRole role) {
    return switch (role) {
      ...
      case BASE_BUNDID_PERSON_LINK_WRITE -> UserRoleDto.BASE_BUNDID_PERSON_LINK_WRITE;
