...
public class UserMapper {
  ...
  public static KeycloakRole mapRoleToDm(UserRoleDto role) {
    return switch (role) {
      ...
      case OFFICIAL_MEDICAL_SERVICE_PHYSICIAN ->
          EmployeePermissionRole.OFFICIAL_MEDICAL_SERVICE_PHYSICIAN;
    };
  }
  ...
  private static UserRoleDto mapPermissionRoleToApi(EmployeePermissionRole role) {
    return switch (role) {
      ...
      case OFFICIAL_MEDICAL_SERVICE_PHYSICIAN -> UserRoleDto.OFFICIAL_MEDICAL_SERVICE_PHYSICIAN;
    };
  }
