...
public class UserMapper {
  ...
  public static KeycloakRole mapRoleToDm(UserRoleDto role) {
    return switch (role) {
      ...
      case BUSINESS_MODULE_READ_GDPR_PACKAGE_IDENTIFICATION ->
          EmployeePermissionRole.BUSINESS_MODULE_READ_GDPR_PACKAGE_IDENTIFICATION;
    };
  }
  ...
  private static UserRoleDto mapPermissionRoleToApi(EmployeePermissionRole role) {
    return switch (role) {
      ...
      case BUSINESS_MODULE_READ_GDPR_PACKAGE_IDENTIFICATION ->
          UserRoleDto.BUSINESS_MODULE_READ_GDPR_PACKAGE_IDENTIFICATION;
