...
export function EditableActorSelectorCell(
  props: Readonly<CellContext<Rule, ApiAdminActorSelector>>,
): ReactNode {
  if (!useEditableRow(props.row)) {
    return <ActorSelectorCell {...props} />;
  }
  return <InnerEditableActorSelectorCell {...props} />;
}

function InnerEditableActorSelectorCell(
  props: Readonly<CellContext<Rule, ApiAdminActorSelector>>,
): ReactNode {
