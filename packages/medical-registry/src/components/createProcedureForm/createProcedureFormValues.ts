...
export interface MedicalRegistryCreateProcedureFormValues {
  ...
  employeesForm: EmployeesFormValues;
...
export interface EmployeeChangeEntry {
  firstName: string;
  lastName: string;
  dateOfBirth: OptionalFieldValue<Date>;
  changeType: OptionalFieldValue<ApiEmployeeChangeType>;
}
...
export interface EmployeesFormValues {
  employees: EmployeeChangeEntry[];
}
...
const initialEmployeesFormValues: EmployeesFormValues = {
  employees: [buildEmptyEmployeeChangeEntry()],
};
...
export const INITIAL_PROCEDURE_FORM_VALUES: MedicalRegistryCreateProcedureFormValues =
  {
    ...
    employeesForm: initialEmployeesFormValues,
...
export function buildEmptyEmployeeChangeEntry(): EmployeeChangeEntry {
  return { firstName: "", lastName: "", dateOfBirth: "", changeType: "" };
}
