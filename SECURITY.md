...
This document describes the security policy and reporting procedures for the ga-lotse-code
project.
...
Our team takes all security issues in GA-Lotse seriously.  
If you want to report a security issue we appreciate your effort and kindly ask you to submit a responsible disclosure.  
Unfortunately, GA-Lotse does not offer a bug bounty programme or other forms of monetary compensation yet. 
Also, we can acknowledge your effort publicly in the project.  
Thank you for improving the security of the GA-Lotse project!

Report security issues via email at [security@ga-lotse.de](mailto:security@ga-lotse.de?subject=Security%20Issue%20ga-lotse-code).

The GA-Lotse team acknowledges your email within 24 hours and will further respond in detail within 48 hours, explaining the induced actions.  
