...
import { Acknowledgements } from "@/lib/configurator/components/shared/ConfiguratorDetails/Acknowledgements";
...
export default function AcknowledgementsConfiguratorPage(
  ...
  return (
    ...
    >
      <Acknowledgements module={module} />
    </ConfiguratorLayout>
  );
}
