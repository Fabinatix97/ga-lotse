...
import { InspectionService } from "@/lib/configurator/components/shared/ConfiguratorDetails/InspectionService";
...
export default function InspectionConfiguratorPage(
  ...
  return (
    ...
    >
      <InspectionService module={module} />
    </ConfiguratorLayout>
  );
}
