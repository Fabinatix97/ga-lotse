...
import { ProstituteProtection } from "@/lib/configurator/components/shared/ConfiguratorDetails/ProstituteProtection";
...
export default function ProstituteProtectionConfiguratorPage(
  ...
  return (
    ...
    >
      <ProstituteProtection module={module} />
    </ConfiguratorLayout>
  );
}
