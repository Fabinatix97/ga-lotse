...
export const REQUIRED_PROCEDURE_AREAS: EnumMap<string> = {
  DETAILS: "Details",
  HEARING_TEST: "Hörscreening",
  EYE_EXAMINATION: "Sehscreening",
  ANAMNESIS: "Anamnese",
  SOPESS_EXAMINATION: "S1 - SOPESS 2019",
  DEVELOPMENT_SCREENING: "S1 - Befund",
  VACCINATION_STATUS: "Impfstatus",
};

export const REQUIRED_PROCEDURE_PROPERTIES: EnumMap<ApiProcedureProperty> = {
  HEARING_TEST_EXAMINATION_RESULT: "Hörscreening",
  EYE_EXAMINATION_EYE_EXAMINATION: "Sehscreening",
  EYE_EXAMINATION_ISHIHARA_EXAMINATION: "Ishihara",
  EYE_EXAMINATION_LANG_EXAMINATION: "Lang-Test",
  ANAMNESIS_BIRTH_WEIGHT: "Gewicht",
  ANAMNESIS_CHILD_LANGUAGE_SCREENING: "KiSS",
  ANAMNESIS_COUNTRY_OF_BIRTH_CHILD: "Geburtsland Kind",
  ANAMNESIS_COUNTRY_OF_BIRTH_FIRST_PARENT: "Geburtsland des Elternteil 1",
  ANAMNESIS_COUNTRY_OF_BIRTH_SECOND_PARENT: "Geburtsland des Elternteil 2",
  ANAMNESIS_EARLY_SUPPORT: "Frühförderung",
  ANAMNESIS_ERGOTHERAPY: "Ergotherapie",
  ANAMNESIS_INTEGRATION_PLACE: "Integrationsplatz",
  ANAMNESIS_NATIONALITY_CHILD: "StA bei Geb. Kind",
  ANAMNESIS_NATIONALITY_FIRST_PARENT: "StA bei Geb. Elternteil 1",
  ANAMNESIS_NATIONALITY_SECOND_PARENT: "StA bei Geb. Elternteil 2",
  ANAMNESIS_NUMBER_OF_SIBLINGS:
    "Anzahl Geschwister / im Haushalt lebende Kinder",
  ANAMNESIS_PHYSIOTHERAPY: "Krankengymnastik",
  ANAMNESIS_PRELIMINARY_COURSE: "Vorlaufkurs",
  ANAMNESIS_SPEECH_THERAPY: "Logopädie",
  ANAMNESIS_U_2: "U2",
  ANAMNESIS_U_3: "U3",
  ANAMNESIS_U_4: "U4",
  ANAMNESIS_U_5: "U5",
  ...
  ANAMNESIS_U_8: "U8",
  ANAMNESIS_U_9: "U9",
  VACCINATION_STATUS_DIPHTHERIA: "Diphtherie",
  VACCINATION_STATUS_HEPATITIS_A: "Hep. A",
  VACCINATION_STATUS_HEPATITIS_B: "Hep. B",
  VACCINATION_STATUS_HIB: "Hib",
  VACCINATION_STATUS_MENINGOCOCCUS_B: "Meningokokken B",
  VACCINATION_STATUS_MENINGOCOCCUS_C: "Meningokokken C",
  VACCINATION_STATUS_MMR: "MMR",
  VACCINATION_STATUS_PERKOMBI_HBV: "PerkombiHBV",
  VACCINATION_STATUS_PERTUSSIS: "Pertussis",
  VACCINATION_STATUS_PNEUMOCOCCUS: "Pneumokokken",
  VACCINATION_STATUS_POLIO: "Polio",
  VACCINATION_STATUS_ROTA: "Rota",
  VACCINATION_STATUS_TBE: "FSME",
  VACCINATION_STATUS_TETANUS: "Tetanus",
  VACCINATION_STATUS_VACCINATION_SCHEME: "Impfschema",
  VACCINATION_STATUS_VARICELLA: "Varizellen",
  SOPESS_EXAMINATION_AUDITIVE_PROCESSING_RESULT: "Auditive Infoverarbeitung",
  SOPESS_EXAMINATION_COUNTING_POINTS: "Zählen Punkte",
  SOPESS_EXAMINATION_FINE_MOTOR_SKILLS: "Visuomotorik Punkte",
  SOPESS_EXAMINATION_FORMATION_CH_POINTS: "Ch",
  SOPESS_EXAMINATION_FORMATION_SCH_POINTS: "Sch",
  SOPESS_EXAMINATION_FORMATIONS_TR_DR_KR_GR_POINTS: "tr, dr, kr, gr",
  SOPESS_EXAMINATION_GROSS_MOTOR_SKILLS: "Grobmotorik",
  SOPESS_EXAMINATION_JUMP_COUNT: "Sprungzahl",
  SOPESS_EXAMINATION_KNOWLEDGE_THINKING_RESULT: "Wissen/Denken",
  SOPESS_EXAMINATION_LETTER_B_POINTS: "B",
  SOPESS_EXAMINATION_LETTER_F_AND_FORMATION_PF_POINTS: "F, Pf",
  SOPESS_EXAMINATION_LETTER_R_POINTS: "R",
  SOPESS_EXAMINATION_LETTERS_G_AND_K_POINTS: "G, K",
  SOPESS_EXAMINATION_LETTERS_L_AND_N_POINTS: "L, N",
  SOPESS_EXAMINATION_LETTERS_S_AND_Z_POINTS: "S, Z",
  SOPESS_EXAMINATION_LETTERS_T_AND_D_POINTS: "T, D",
  SOPESS_EXAMINATION_PLURAL_POINTS: "Plurale Punkte",
  SOPESS_EXAMINATION_PREPOSITION_POINTS: "Präpositionen Punkte",
  SOPESS_EXAMINATION_PRIMARY_LANGUAGE: "Erstsprache",
  SOPESS_EXAMINATION_PSEUDOWORD_POINTS: "Pseudowörter Punkte",
  SOPESS_EXAMINATION_PSYCHOLOGICAL_BEHAVIOR_RESULT: "Psych. Verhalten",
  SOPESS_EXAMINATION_QUANTITY_KNOWLEDGE_POINTS: "Mengenvorwissen Punkte",
  SOPESS_EXAMINATION_SELECTIVE_ATTENTION_POINTS:
    "Selektive Aufmerksamkeit Punkte",
  SOPESS_EXAMINATION_SPEECH_RESULT: "Plurale Sprache",
  SOPESS_EXAMINATION_VISUAL_PERCEPTION_POINTS: "Visuelle Wahrnehmung Punkte",
  SOPESS_EXAMINATION_VISUAL_PERCEPTION_RESULT: "Visuelle Wahrnehmung",
  SOPESS_EXAMINATION_VISUO_MOTOR: "Visumotorik Punkte",
  DEVELOPMENT_SCREENING_ABDOMEN: "",
  DEVELOPMENT_SCREENING_CHRONIC_DISEASE: "",
  DEVELOPMENT_SCREENING_DIASTOLE: "RRdiast (mmHg)",
  DEVELOPMENT_SCREENING_DISABILITY: "",
  DEVELOPMENT_SCREENING_EAR_NOSE_THROAT: "",
  DEVELOPMENT_SCREENING_EDUCATIONAL_ADVICE: "Erziehungsber.",
  DEVELOPMENT_SCREENING_EXTRA_EFFORT: "Mehraufwand",
  DEVELOPMENT_SCREENING_HEIGHT: "Größe (cm)",
  DEVELOPMENT_SCREENING_INFO_LETTER: "Schulinfobrief",
  DEVELOPMENT_SCREENING_LANGUAGE_ADVICE: "Sprachförderung",
  DEVELOPMENT_SCREENING_METABOLISM: "",
  DEVELOPMENT_SCREENING_MOTOR_PROMOTION: "Motorikförderung",
  DEVELOPMENT_SCREENING_MUSCULATURE_SKELETON: "",
  DEVELOPMENT_SCREENING_NEUROLOGY: "",
  DEVELOPMENT_SCREENING_NUTRITIONAL_ADVICE: "Ernährungsber.",
  DEVELOPMENT_SCREENING_NUTRITIONAL_CONDITION: "",
  DEVELOPMENT_SCREENING_OTHER_SUPPORT: "Sonstige Hilfen",
  DEVELOPMENT_SCREENING_RE_INTRODUCTION: "Sprechstunde",
  DEVELOPMENT_SCREENING_RESPIRATORY_CARDIOVASCULAR: "",
  DEVELOPMENT_SCREENING_SCHOOL_COUNSELLING: "Schulberatung",
  DEVELOPMENT_SCREENING_SCHOOL_RECOMMENDATION: "Empfehlungen",
  DEVELOPMENT_SCREENING_SKIN: "",
  DEVELOPMENT_SCREENING_SOCIAL_SERVICE: "Sozialdienst",
  DEVELOPMENT_SCREENING_SYSTOLE: "RRsys (mmHg)",
  DEVELOPMENT_SCREENING_VACCINATION_ADVICE: "Impfberatung",
  DEVELOPMENT_SCREENING_WEIGHT: "Gewicht (kg)",
  ...
  SOPESS_EXAMINATION_DOCTOR_LETTER_AUDITIVE_PROCESSING:
    "RM Auditive Infoverarbeitung",
  SOPESS_EXAMINATION_DOCTOR_LETTER_FINE_MOTOR_SKILLS: "RM Visuomotorik",
  SOPESS_EXAMINATION_DOCTOR_LETTER_GROSS_MOTOR_SKILLS: "RM Grobmotorik",
  SOPESS_EXAMINATION_DOCTOR_LETTER_KNOWLEDGE_THINKING: "RM Wissen/Denken",
  SOPESS_EXAMINATION_DOCTOR_LETTER_PSYCHOLOGICAL_BEHAVIOR:
    "RM Psych. Verhalten",
  SOPESS_EXAMINATION_DOCTOR_LETTER_SPEECH: "RM Sprache",
  SOPESS_EXAMINATION_DOCTOR_LETTER_VISUAL_PERCEPTION: "RM Visuelle Wahrnehmung",
  SOPESS_EXAMINATION_FAMILY_LANGUAGE: "Familiensprache",
  SOPESS_EXAMINATION_GERMAN_KNOWLEDGE_CHILD: "Deutschkenntnisse",
  SOPESS_EXAMINATION_GERMAN_KNOWLEDGE_PRIMARY_CARER:
    "Deutschkenntnisse Hauptbezugsperson",
  SOPESS_EXAMINATION_IN_GERMANY_SINCE: "in Deutschland seit",
  SOPESS_EXAMINATION_HANDEDNESS_VALUE: "",
  SOPESS_EXAMINATION_NOTE: "",
  DEVELOPMENT_SCREENING_BMI: "",
  DEVELOPMENT_SCREENING_BMI_PERCENTILE: "",
  DEVELOPMENT_SCREENING_DISABILITY_TYPE: "Behinderungs-Art",
  ...
  APPOINTMENT: "Termin",
  EXAMINATION_DATE: "",
  HEARING_TEST_EXAMINATION_RESULT_DOCTOR_LETTER: "RM Hörscreening",
  EYE_EXAMINATION_EYE_EXAMINATION_DOCTOR_LETTER: "RM Sehscreening",
  EYE_EXAMINATION_ISHIHARA_EXAMINATION_DOCTOR_LETTER: "RM Ishihara",
  EYE_EXAMINATION_LANG_EXAMINATION_DOCTOR_LETTER: "RM Lang-Test",
  DEVELOPMENT_SCREENING_ABDOMEN_RESULT: "Abdomen",
  DEVELOPMENT_SCREENING_ABDOMEN_DOCTOR_LETTER: "RM Abdomen",
  DEVELOPMENT_SCREENING_METABOLISM_RESULT: "Endo/Stoffw.",
  DEVELOPMENT_SCREENING_METABOLISM_DOCTOR_LETTER: "RM Endo/Stoffw.",
  DEVELOPMENT_SCREENING_MUSCULATURE_SKELETON_RESULT: "Muskulatur, Skelett",
  DEVELOPMENT_SCREENING_MUSCULATURE_SKELETON_DOCTOR_LETTER:
    "RM Muskulatur, Skelett",
  DEVELOPMENT_SCREENING_NEUROLOGY_RESULT: "Neurologie",
  DEVELOPMENT_SCREENING_NEUROLOGY_DOCTOR_LETTER: "RM Neurologie",
  DEVELOPMENT_SCREENING_SKIN_RESULT: "Haut",
  DEVELOPMENT_SCREENING_SKIN_DOCTOR_LETTER: "RM Haut",
  DEVELOPMENT_SCREENING_NUTRITIONAL_CONDITION_RESULT: "Ernährungszustand",
  DEVELOPMENT_SCREENING_NUTRITIONAL_CONDITION_DOCTOR_LETTER:
    "RM Ernährungszustand",
  DEVELOPMENT_SCREENING_RESPIRATORY_CARDIOVASCULAR_RESULT:
    "Atmung-Herz-Kreislauf",
  DEVELOPMENT_SCREENING_RESPIRATORY_CARDIOVASCULAR_DOCTOR_LETTER:
    "RM Atmung-Herz-Kreislauf",
  DEVELOPMENT_SCREENING_EAR_NOSE_THROAT_RESULT: "HNO",
  DEVELOPMENT_SCREENING_EAR_NOSE_THROAT_DOCTOR_LETTER: "RM HNO",
  DEVELOPMENT_SCREENING_CHRONIC_DISEASE_RESULT: "chron. Krankheit",
  DEVELOPMENT_SCREENING_CHRONIC_DISEASE_ICD10: "chron. Krankheit ICD-10",
  DEVELOPMENT_SCREENING_DISABILITY_RESULT: "Behinderung",
  DEVELOPMENT_SCREENING_DISABILITY_ICD10: "Behinderung ICD-10",
};

//Körp Untersuchung 8 Rückmeludngen fehlen (und ICD 10)
//  DEVELOPMENT_SCREENING_CHRONIC_DISEASE_RESULT gibt es nicht -> sollte boolean sein
//EXAMINATIONDATE unnötig
