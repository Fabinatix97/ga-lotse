...
export function CreateAppointmentSidebar({
  ...
  const appointmentType = editAppointmentType as ApiAppointmentType | null;
        ...
        <SidebarForm ref={sidebarFormRef}>
          <SidebarContent title={step.title} subtitle={step.subTitle}>
            <Fields
              ...
              editAppointmentType={appointmentType ?? undefined}
            />
          </SidebarContent>
          <SidebarActions>
            <MultiFormButtonBar
...
function mapFormToApi(form: CreateAppointmentForm, type: "edit" | "create") {
  ...
  if (!isCustomAppointment && blockAppointmentEnd === undefined) {
