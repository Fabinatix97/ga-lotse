...
} from "@/lib/businessModules/chat/shared/UnreadNotificationsPerRoomProvider";
...
const EMPTY_NOTIFICATIONS: UnreadNotificationsPerRoom = {};
...
export function useNewMessages() {
  ...
  const unreadNotificationsPerRoom =
    useContext(UnreadNotificationsPerRoomContext) ?? EMPTY_NOTIFICATIONS;
