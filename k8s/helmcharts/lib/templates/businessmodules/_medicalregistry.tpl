{{- define "module.medicalregistry.container" }}
...
- name: spring.security.oauth2.client.registration.module-client.client-id
  value: system-medical-registry
{{- if .Values.businessmodules.medicalregistry.ratelimit }}
- name: de.eshg.medical-registry.rate-limit-capacity
  value: "{{ .Values.businessmodules.medicalregistry.ratelimit.capacity | default 60 }}"
- name: de.eshg.medical-registry.rate-limit-interval-minutes
  value: "{{ .Values.businessmodules.medicalregistry.ratelimit.interval | default 60 }}"
- name: de.eshg.medical-registry.draft-entry-limit
  value: "{{ .Values.businessmodules.medicalregistry.ratelimit.drafts | default 1000 }}"
{{- end }}
