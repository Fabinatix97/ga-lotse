...
export const ANAMNESIS_TOTAL_STEPS = 3;
...
export const INITIAL_VALUES: AnamnesisFormValues = {
  affectedPersonInfo: {
    fillingPerson: "",
    maritalStatus: "",
    numberOfChildren: 0,
