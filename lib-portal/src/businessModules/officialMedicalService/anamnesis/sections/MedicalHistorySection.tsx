...
import { validatePositiveInteger } from "../../../../helpers/validators";
import {
  OptionalFieldValue,
  SetFieldValueHelper,
} from "../../../../types/form";
...
import { AnamnesisFormValues } from "../formConfig";
import {
  useAddictionOptions,
      ...
      {props.hadPastDiseasesOrDisabilities && (
        <Stack direction="column" gap={3} divider={<Divider />}>
          ...
          <RadioButtonsField
            ...
            label={t("tuberculosis.answer.label")}
            required={t("tuberculosis.answer.required")}
          />
          <RadioButtonsWithFollowUp
            options={booleanWithUnknownOptions}
